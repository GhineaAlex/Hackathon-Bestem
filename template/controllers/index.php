...
if (!defined('ALLOW'))
    exit;
if (self::$_user_type != 0)
    __U::__update_user_information($_SESSION['openid']);

$results = DB::__db_query(core::$mysql_handle, DB::$DB_FETCH, DB::$DB_NONPROTECTED, 'SELECT * FROM `popup` ORDER BY `ID` DESC LIMIT 1');
